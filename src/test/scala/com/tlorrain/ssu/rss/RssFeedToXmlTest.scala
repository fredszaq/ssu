...
class RssFeedToXmlTest extends FunSuite with ShouldMatchers {
  ...
  val items = ("title1", "content1", "http://link1.com", "author1@site1.com") :: ("title2", "content2", "http://link2.com", "author2@site2.com") :: Nil

  test("generate correct XML (simple version)") {

    val rss = (
      RssFeed("some title", "http://someli.nk", "some description")
      withCopyright "SSU"
  ...
  test("generate correct XML (full version)") {
    ...
    val rss = (
      ...
      withItems (items map (item => RssItem
        ...
        withAuthor item._4
        withCategory RssCategory("IT", Some("http://www.yetanotherlink.org"))
        withComments "http://www.comments-url.net"
        withEnclosure RssEnclosure("http://www.localtion.biz", 7839, "image/png")
        withGuid item._3
        withPubDate 1357924680
        withSource RssSource("http://www.sourceurl.eu", "Very cool site")))).toXml

    val expected = <rss version="2.0"><channel><title>some title</title><link>http://someli.nk</link><description>some description</description><language>en</language><copyright>SSU</copyright><managingEditor>somebody@somewhere.com</managingEditor><webMaster>somebodyElse@somewhere.com</webMaster><pubDate>Thu, 1 Jan 1970 01:00:00 +0100</pubDate><lastBuildDate>Thu, 15 Jan 1970 07:56:07 +0100</lastBuildDate><category domain="http://www.yetanotherlink.org">IT</category><generator>Scala Syndication Utils</generator><docs>http://www.rssboard.org/rss-specification</docs><cloud>TODO</cloud><ttl>60</ttl><image>TODO</image><rating>TODO</rating><textInput>TODO</textInput><skipHours><hour>0</hour><hour>1</hour><hour>12</hour><hour>15</hour></skipHours><skipDays><day>Saturday</day><day>Sunday</day></skipDays><item><title>title1</title><description>content1</description><link>http://link1.com</link><author>author1@site1.com</author><category domain="http://www.yetanotherlink.org">IT</category><comments>http://www.comments-url.net</comments><enclosure url="http://www.localtion.biz" length="7839" type="image/png"/><guid>http://link1.com</guid><pubDate>Fri, 16 Jan 1970 18:12:04 +0100</pubDate><source url="http://www.sourceurl.eu">Very cool site</source></item><item><title>title2</title><description>content2</description><link>http://link2.com</link><author>author2@site2.com</author><category domain="http://www.yetanotherlink.org">IT</category><comments>http://www.comments-url.net</comments><enclosure url="http://www.localtion.biz" length="7839" type="image/png"/><guid>http://link2.com</guid><pubDate>Fri, 16 Jan 1970 18:12:04 +0100</pubDate><source url="http://www.sourceurl.eu">Very cool site</source></item></channel></rss>
